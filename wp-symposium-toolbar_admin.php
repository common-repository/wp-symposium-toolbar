...
function symposium_toolbar_admintab_toolbar() {
	...
	echo '<div class="postbox"><div class="inside">';
		...
		echo '<tr valign="top">';
			echo '<td scope="row" class="wpst-form-item-title"><span>'.__( 'Customize Icon', 'wp-symposium-toolbar' ).'</span></td>';
			echo '<td>';
				echo '<span>' . __( 'The Customize icon, links to the Customizer', 'wp-symposium-toolbar' ) . '</span>';
				echo symposium_toolbar_add_roles_to_item( 'display_customize_icon', get_option( 'wpst_toolbar_customize', array_keys( $wpst_roles_customize ) ), $wpst_roles_customize );
			echo '</td>';
		echo '</tr>';
...
function symposium_toolbar_admintab_menus() {
	...
	global $wpst_roles_all_incl_visitor, $wpst_roles_all, $wpst_roles_author, $wpst_roles_new_content, $wpst_roles_comment, $wpst_roles_customize, $wpst_roles_updates, $wpst_roles_administrator, $wpst_locations;
