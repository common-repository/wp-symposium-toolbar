...
jQuery(document).ready(function($){
	...
	function update_tb_icon_size() {
		...
		style.innerHTML += '#wpadminbar li.hover .ab-item span:before, #wpadminbar li.menupop.hover .ab-item span:before, #wpadminbar .ab-top-menu > li.hover > .ab-item:before, #wpadminbar .ab-top-menu > li.menupop.hover > .ab-item:before, #wpadminbar li.hover > .ab-item > .ab-icon, #wpadminbar li.menupop.hover > .ab-item > .ab-icon, #wpadminbar li.hover > .ab-item > .ab-icon:before, #wpadminbar li.menupop.hover > .ab-item > .ab-icon:before, #wpadminbar #wp-admin-bar-my-account.with-avatar:hover > a img, #wpadminbar .quicklinks li#wp-admin-bar-my-account.with-avatar:hover > a img, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item > .ab-icon:before, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item:after, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item:before, #wpadminbar:not(.mobile) li:hover #adminbarsearch:before ,#wpadminbar.mobile .quicklinks .hover .ab-icon:before, #wpadminbar.mobile .quicklinks .hover .ab-item:before { '+tbTransform+' } ';
	...
	function update_tb_font_colour() {
		...
		// Fonticons Hover
		style.innerHTML += '#wpadminbar li.hover .ab-item span:before, #wpadminbar li.menupop.hover .ab-item span:before, #wpadminbar .ab-top-menu > li.hover > .ab-item:before, #wpadminbar .ab-top-menu > li.menupop.hover > .ab-item:before, #wpadminbar li.hover > .ab-item > .ab-icon:before, #wpadminbar li.menupop.hover > .ab-item > .ab-icon:before, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item > .ab-icon:before, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item:after, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item:before, #wpadminbar:not(.mobile) li:hover #adminbarsearch:before, #wpadminbar.mobile .quicklinks .hover .ab-icon:before, #wpadminbar.mobile .quicklinks .hover .ab-item:before { color: '+tbHoverIconColor+'; } ';
	...
	function update_tb_font_shadow() {
		...
		// admin-bar.css:215
		style.innerHTML += '#wpadminbar:not(.mobile) .ab-top-menu > li > .ab-item:focus, #wpadminbar.nojq .quicklinks .ab-top-menu > li > .ab-item:focus, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item, #wpadminbar .ab-top-menu > li.hover > .ab-item, #wpadminbar:not(.mobile) > #wp-toolbar li:hover span.ab-label, #wpadminbar > #wp-toolbar li.hover span.ab-label, #wpadminbar:not(.mobile) > #wp-toolbar a:focus span.ab-label { text-shadow: '+tbHoverFontShadow+'; } ';
		
		// Fonticons Hover
		style.innerHTML += '#wpadminbar li.hover .ab-item span:before, #wpadminbar li.menupop.hover .ab-item span:before, #wpadminbar .ab-top-menu > li.hover > .ab-item:before, #wpadminbar .ab-top-menu > li.menupop.hover > .ab-item:before, #wpadminbar li.hover > .ab-item > .ab-icon:before, #wpadminbar li.menupop.hover > .ab-item > .ab-icon:before, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item > .ab-icon:before, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item:after, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item:before, #wpadminbar:not(.mobile) li:hover #adminbarsearch:before, #wpadminbar.mobile .quicklinks .hover .ab-icon:before, #wpadminbar.mobile .quicklinks .hover .ab-item:before { text-shadow: '+tbHoverFontShadow+'; } ';
	...
	function update_menu_font_colour() {
		...
		style.innerHTML = '#wpadminbar:not(.mobile) li:hover .ab-submenu .ab-item:before, #wpadminbar .menupop .menupop > .ab-item:before, #wpadminbar:not(.mobile) li:hover li .ab-item:before, #wpadminbar:not(.mobile) li:hover li .ab-icon:before, #wpadminbar:not(.mobile) li:hover li .ab-item:after { color: '+menuMainColor+'; } ';
		style.innerHTML += '#wpadminbar:not(.mobile) li:hover .ab-sub-secondary .ab-item:before, #wpadminbar .menupop .ab-sub-secondary > .menupop > .ab-item:before, #wpadminbar .menupop .ab-sub-secondary > .menupop > .ab-item { color: '+menuMainColorExt+'; } ';
		style.innerHTML += '#wpadminbar .quicklinks li > a > .blavatar, #wpadminbar .quicklinks li > a > .blavatar:before { color: '+menuMainColorExt+'; } ';
		
		style.innerHTML += '#wpadminbar .menupop .menupop > .ab-item:hover:before, #wpadminbar .menupop li.menupop:hover > .ab-item:before { color: '+menuHoverColor+'; } ';
		style.innerHTML += '#wpadminbar .quicklinks li.hover > a > .blavatar, #wpadminbar .quicklinks li.hover > a > .blavatar:before, #wpadminbar .quicklinks li a:hover .blavatar, #wpadminbar .quicklinks li a:hover .blavatar:before { color: '+menuHoverColorExt+'; } ';
	...
	function update_menu_font_shadow() {
		...
		style.innerHTML = '#wpadminbar .menupop .menupop > .ab-item:before, #wpadminbar:not(.mobile) li:hover li .ab-item:before, #wpadminbar:not(.mobile) li:hover li .ab-icon:before, #wpadminbar:not(.mobile) li:hover li .ab-item:after, ';
		style.innerHTML += '#wpadminbar:not(.mobile) li:hover .ab-sub-secondary .ab-item:before, #wpadminbar .menupop .ab-sub-secondary > .menupop > .ab-item:before, ';
	...
	$('.wpst_font_style').change(function() {
		...
		// Make sure default font color will be added to menu items
