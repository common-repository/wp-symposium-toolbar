...
function symposium_toolbar_update() {
	...
	global $wpdb;
	global $wpst_roles_all_incl_visitor, $wpst_roles_all_incl_user, $wpst_roles_all, $wpst_roles_author, $wpst_roles_new_content, $wpst_roles_comment, $wpst_roles_customize, $wpst_roles_updates, $wpst_roles_administrator;
	...
	if ( get_option( 'wpst_tech_buildnr', 0 ) < 3216 ) {
		
		if ( !is_array( get_option( 'wpst_toolbar_customize', '' ) ) ) update_option( 'wpst_toolbar_customize', array_keys( $wpst_roles_customize ) );
	}
	...
	if ( isset( $_POST["symposium_toolbar_view"] ) && ( check_admin_referer( 'wpst_save_options', 'wpst_save_options_nonce_field' ) ) ) {
		...
		if ( isset( $_POST["Submit"] ) && $_POST["Submit"] == __( 'Save Changes', 'wp-symposium-toolbar' ) ) {
			...
			if ( $_POST["symposium_toolbar_view"] == 'toolbar' ) {
				...
				update_option( 'wpst_toolbar_customize', ( isset( $_POST["display_customize_icon_roles"] ) && is_array( $_POST["display_customize_icon_roles"] ) ) ? $_POST["display_customize_icon_roles"] : array() );
		...
		// Sixth set of options - Technical
			...
			if ( is_multisite() && !is_main_site() && is_plugin_active_for_network( 'stellar-toolbar/stellar-toolbar.php' )
				&& isset( $_POST["Submit"] ) && $_POST["Submit"] == __( 'Import from Main Site', 'wp-symposium-toolbar' ) ) {
...
function symposium_toolbar_update_styles( $wpst_style_tb_current, $blog_id = "1" ) {
	...
	if ( ( $wpst_style_tb_current['border_width'] != "0" ) && ( $wpst_style_tb_current['border_style'] != 'none' ) && ( isset( $wpst_style_tb_current['border_left_colour'] ) ) ) {
		...
		if ( isset( $wpst_style_tb_current['border_right_colour'] ) ) {
			...
			$style_saved .= apply_filters( 'symposium_toolbar_style_toolbar_hover', '#wpadminbar .ab-top-menu > li:hover > .ab-item, #wpadminbar .ab-top-menu > li.hover > .ab-item, #wpadminbar .ab-top-menu > li.menupop:hover > .ab-item, #wpadminbar .ab-top-menu > li.menupop.hover > .ab-item, #wpadminbar.nojs .ab-top-menu > li.menupop:hover > .ab-item, #wpadminbar:not(.mobile) .ab-top-menu > li > .ab-item:focus, #wpadminbar.nojq .quicklinks .ab-top-menu > li > .ab-item:focus, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item { border-left: '.$border_left.'; border-right: '.$border_right.'; } ' );
	...
	if ( ( $icon_size != $wpst_default_toolbar['icon_size'] ) || ( $height != $wpst_default_toolbar['height'] ) ) {
		...
		if ( get_option( 'wpst_toolbar_customize', array() ) != array() ) { $style_chunk .= $comma.'#wpadminbar #wp-admin-bar-customize > .ab-item:before'; $comma = ', '; }
	...
	if ( $style_chunk != "" ) {
		...
		$style_saved .= '#wpadminbar .ab-top-menu > li:hover > .ab-item, #wpadminbar .ab-top-menu > li.hover > .ab-item, #wpadminbar .ab-top-menu > li.menupop.hover > .ab-item, #wpadminbar.nojs .ab-top-menu > li.menupop:hover > .ab-item, #wpadminbar:not(.mobile) .ab-top-menu > li > .ab-item:focus, #wpadminbar.nojq .quicklinks .ab-top-menu > li > .ab-item:focus, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item, #wpadminbar .menupop.focus .ab-label { ' . $style_chunk . '} ';
		
		if ( $has_gradient && ( $height != $wpst_default_toolbar['tablet_toolbar_height'] ) ) {
			$style_saved .= '} ';
			$style_saved .= '@media screen and ( max-width: 782px ) { ';
			$style_saved .= '#wpadminbar .ab-top-menu > li:hover > .ab-item, #wpadminbar .ab-top-menu > li.hover > .ab-item, #wpadminbar .ab-top-menu > li.menupop.hover > .ab-item, #wpadminbar.nojs .ab-top-menu > li.menupop:hover > .ab-item, #wpadminbar:not(.mobile) .ab-top-menu > li > .ab-item:focus, #wpadminbar.nojq .quicklinks .ab-top-menu > li > .ab-item:focus, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item, #wpadminbar .menupop.focus .ab-label { ' . $style_chunk_tablet . '} ';
			$style_saved .= '} ';
		}
	...
	if ( $style_chunk != "" ) {
		$style_saved .= '#wpadminbar:not(.mobile) > #wp-toolbar li.hover span.ab-label, #wpadminbar .ab-top-menu > li.hover span.ab-label, #wpadminbar .ab-top-menu > li:hover span.ab-label, ';
		$style_saved .= '#wpadminbar .ab-top-menu > li.menupop.hover > .ab-item, #wpadminbar .ab-top-menu > li.menupop:hover span.ab-label, ';
		// admin-bar.css:215
		$style_saved .= '#wpadminbar:not(.mobile) .ab-top-menu > li > .ab-item:focus, #wpadminbar.nojq .quicklinks .ab-top-menu > li > .ab-item:focus, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item, #wpadminbar .ab-top-menu > li.hover > .ab-item, #wpadminbar:not(.mobile) > #wp-toolbar li:hover span.ab-label, #wpadminbar > #wp-toolbar li.hover span.ab-label, #wpadminbar:not(.mobile) > #wp-toolbar a:focus span.ab-label, ';
	...
	if ( isset( $wpst_style_tb_current['hover_icon_size'] ) )
		if ( $wpst_style_tb_current['hover_icon_size'] != '' ) {
			...
			if ( $icon_size > 0 ) {
				...
				$style_saved .= '#wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item > .ab-icon:before, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item:after, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item:before, #wpadminbar:not(.mobile) li:hover #adminbarsearch:before, ';
				$style_saved .= '#wpadminbar .ab-top-menu > li.hover > .ab-item:before, #wpadminbar .ab-top-menu > li.hover > .ab-item > .ab-icon, #wpadminbar .ab-top-menu > li.hover > .ab-item > .ab-icon:before, #wpadminbar li a:focus .ab-icon:before, #wpadminbar li .ab-item:focus:before, #wpadminbar li:hover #adminbarsearch:before, ';
				$style_saved .= '#wpadminbar.mobile .quicklinks .hover .ab-icon:before, #wpadminbar.mobile .quicklinks .hover .ab-item:before ';
	...
	if ( ( $icon_colour . $hover_font_shadow != "" ) && ( $icon_colour != 'color: '.$wpst_default_toolbar['hover_icon_colour'].'; ' ) ) {
		...
		$style_saved .= '#wpadminbar.mobile .quicklinks .hover .ab-icon:before, #wpadminbar.mobile .quicklinks .hover .ab-item:before { '.$icon_colour.$hover_font_shadow.'} ';
	...
	if ( $style_chunk . $style_chunk_shadow != "" )
		$style_saved .= '#wpadminbar .menupop .menupop > .ab-item:before, #wpadminbar:not(.mobile) li:hover li .ab-item:before, #wpadminbar:not(.mobile) li:hover li .ab-icon:before, #wpadminbar:not(.mobile) li:hover li .ab-item:after { ' .$style_chunk . $style_chunk_shadow . '} ';
	...
	if ( $style_chunk . $style_chunk_shadow != '' ) {
		...
		// Arrows
		$style_saved .= '#wpadminbar:not(.mobile) li:hover .ab-sub-secondary .ab-item:before, #wpadminbar .menupop .ab-sub-secondary > .menupop > .ab-item:before ';
